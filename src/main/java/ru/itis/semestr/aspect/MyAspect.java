package ru.itis.semestr.aspect;
...
public class MyAspect {
    ...
    @Pointcut("execution(public * ru.itis.semestr.aspect.service.MyService.*(..))")
    public void callAtMyServicePublic() { }

    @Pointcut("@annotation(AspectAnnotation)")
    public void callAtMyServiceAnnotation() { }

    @Pointcut("execution(* ru.itis.semestr.aspect.service.MyService.method1(..)) && args(list,..))")
    public void callAtMyServiceMethod1(List<String> list) { }

    @Pointcut("execution(* ru.itis.semestr.aspect.service.MyService.check())")
